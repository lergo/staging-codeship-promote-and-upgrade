...
aws s3 cp s3://staging-promote-upgrade-number-tracker/build-tracker.txt build-tracker.txt
...
aws s3 cp build-tracker.txt s3://staging-promote-upgrade-number-tracker/build-tracker.txt 
